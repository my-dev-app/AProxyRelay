...
class ParserSpysUS(MainScraper):
    ...
    async def format_raw(cls, html: str) -> list:
        ...
        for row in rows:
            ...
            if len(cells) == 9:
                ...
                data_dict = {
                    'Proxy': None if not cells[0].find('font', class_='spy14') else cells[0].find('font', class_='spy14').text.strip(),
                    'Type': None if not cells[1].find('font', class_='spy1') else cells[1].find('font', class_='spy1').text.strip(),
                    'Anonymity': None if not cells[2].find('font', class_='spy5') else cells[2].find('font', class_='spy5').text.strip(),
                    'Country': None if not cells[3].find('font', class_='spy14') else cells[3].find('font', class_='spy14').text.strip(),
                    'Hostname/ORG': None if not cells[4].find('font', class_='spy1') else cells[4].find('font', class_='spy1').text.strip(),
                    'Latency': None if not cells[5].find('font', class_='spy1') else cells[5].find('font', class_='spy1').text.strip(),
                    'Speed': None if not cells[6].find('font', class_='spy1') else cells[6].find('font', class_='spy1').text.strip(),
                    'Uptime': None if not cells[7].find('font', class_='spy1') else cells[7].find('font', class_='spy1').text.strip(),
                    'Check Date': None if not cells[8].find('font', class_='spy1') else cells[8].find('font', class_='spy1').text.strip(),
                }
